...
CREATE TABLE `question_paper` (
  ...
  CONSTRAINT `pprid` FOREIGN KEY (`p_id`) REFERENCES `papers` (`ppr_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `question_paper` VALUES (2,1,2019,2),(3,2,2020,1),(4,2,2021,2),(5,3,2021,1),(7,3,2019,1);
